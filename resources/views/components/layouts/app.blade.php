                ...
                <nav class="border-gray-200 bg-white dark:bg-slate-300" dark:border-gray-700">
                    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
                        <a href="{{ route('/') }}" class="flex items-center space-x-3 rtl:space-x-reverse">
                            ...
                            <span class="self-center text-center text-2xl font-semibold whitespace-nowrap dark:text-black">N.I.C & Associés</span>
                        </a>
                        ...
                        <ul id="navbar-default" class="hidden w-full md:flex md:w-auto font-medium mt-4 rounded-lg dark:border-gray-700">
                            <li>
                                <a href="{{ route('/') }}" class="flex items-center py-2 px-3 text-gray-900 rounded hover:bg-gold dark:text-black dark:hover:text-white">                  
                                    <span>Accueil</span>
                                </a>
                            </li>
                            <li>
                                <a href="#services" class="flex items-center py-2 px-3 text-gray-900 rounded hover:bg-gold dark:text-black dark:hover:text-white">                  
                                    <span>Nos services</span>
                                </a>
                            </li>
                            <li>
                                <a href="" class="flex items-center py-2 px-3 text-gray-900 rounded hover:bg-gold dark:text-black dark:hover:text-white">                  
