<x-layouts.error>
    <div class="mt-5 text-center">
        ...
        <h2 class="text-3xl font-bold bg-gradient-to-r from-red-500 to-orange-500 bg-clip-text text-transparent dark:from-red-400 dark:to-orange-400">
            Accès interdit
        </h2>

        <!-- Bouton avec effet de survol et animation -->
        <button
            class="mt-10 inline-flex items-center gap-2 rounded-lg bg-red-500 px-8 py-4 font-semibold text-white shadow-lg transition-all duration-300 hover:scale-105 hover:bg-opacity-90 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 dark:bg-red-600 dark:hover:bg-opacity-90"
