<x-layouts.error>
    <div class="mt-5 text-center">
        ...
        <h2 class="text-3xl font-bold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent dark:from-blue-400 dark:to-purple-400">
            Désolé, cette page est introuvable
        </h2>


        <button
            class="mt-10 inline-flex items-center gap-2 rounded-lg bg-primary px-8 py-4 font-semibold text-white shadow-lg transition-all duration-300 hover:scale-105 hover:bg-opacity-90 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 dark:bg-secondary dark:hover:bg-opacity-90"
