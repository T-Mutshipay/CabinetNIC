<x-layouts.error>
    <div class="mt-5 text-center">
        ...
        <h2 class="text-3xl font-bold bg-gradient-to-r from-yellow-500 to-amber-500 bg-clip-text text-transparent dark:from-yellow-400 dark:to-amber-400">
            Page expirée
        </h2>

        <!-- Bouton avec effet de survol et animation -->
        <button
            class="mt-10 inline-flex items-center gap-2 rounded-lg bg-yellow-500 px-8 py-4 font-semibold text-white shadow-lg transition-all duration-300 hover:scale-105 hover:bg-opacity-90 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2 dark:bg-yellow-600 dark:hover:bg-opacity-90"
