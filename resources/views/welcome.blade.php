<x-layouts.app>
    ...
    <section class="m-14">
        <div class="p-8 bg-gray-100 rounded-md dark:bg-slate-500">
            <div class="container mx-auto text-center">
                ...
                <p class="text-lg md:text-xl text-gray-800 mt-4">
                    Notre engagement envers l'excellence se reflète dans nos valeurs fondamentales : intégrité, transparence et dévouement. Nous sommes fiers de notre réputation de cabinet d'avocats de confiance, reconnu pour notre expertise et notre capacité à obtenir des résultats favorables pour nos clients. En travaillant avec nous, vous bénéficiez non seulement de nos connaissances juridiques approfondies, mais aussi de notre réseau de ressources et de notre engagement indéfectible à protéger vos intérêts.
                </p>
                <p class="text-lg md:text-xl text-gray-800 mt-4">
                    Explorez notre site pour en savoir plus sur chacun de nos avocats et découvrez comment notre équipe peut vous aider à naviguer dans le paysage juridique avec confiance et assurance. Bienvenue chez N.I.C & Associés, où votre réussite est notre priorité.
                </p>
            </div>
        </div>
    ...
    <div class="flex items-center justify-center">
        <div id="carousel" class="relative w-full m-4 overflow-hidden rounded-lg">
            ...
            <button id="prev" type="button" class="absolute top-1/2 -translate-y-1/2 left-0 z-30 p-2 rounded-full bg-gray-700 hover:bg-gray-800 text-white">
                <span>&larr;</span>
            </button>
            <button id="next" type="button" class="absolute top-1/2 -translate-y-1/2 right-0 z-30 p-2 rounded-full bg-gray-700 hover:bg-gray-800 text-white">
                <span>&rarr;</span>
            </button>
        </div>
    </div>
